...
class RevocationEntry:
    ...
    reason: str  # "slashed", "key_compromise", "voluntary", "dispute"
...
class MerkleLog:
    ...
    def append_revocation(self, original: AttestationEntry, reason: str, revoker_id: str,
                          evidence_hash: str = None) -> RevocationEntry:
...
def demo():
    ...
    slash = log.append_revocation(commit, "slashed", "dispute_oracle", evidence_hash="dispute_ruling_xyz")
